    ...
    <div className="space-y-5 animate-fadeIn">
              ...
              <div className="flex flex-wrap justify-between items-start gap-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right hidden sm:block">
                    ...
                    <p className="text-sm text-slate-900 font-bold">{lead.probability}%</p>
                  </div>
      ...
      <div className="bg-white shadow-sm border border-[#D4AF37]/20 rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {markets.map(m => (
            <div key={m.id} className="p-3 bg-gray-50 rounded-lg border border-gray-200 flex justify-between items-center hover:border-[#D4AF37]/20 transition-all group">
              <div>

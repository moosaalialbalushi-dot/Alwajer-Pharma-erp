...
const FIELDS: Record<EntityType, FieldDef[]> = {
  ...
  bd: [
    ...
    { key: 'opportunity', label: 'Opportunity / Product', type: 'text' },
    { key: 'volume', label: 'Volume (Kg)', type: 'number' },
    { key: 'ratePerKg', label: 'Expected Rate (USD/Kg)', type: 'number' },
    { key: 'potentialValue', label: 'Potential Value (USD)', type: 'text' },
  ...
  logistics: [
    ...
    { key: 'clientName', label: 'Client Name', type: 'text' },
    { key: 'direction', label: 'Direction', type: 'select', options: ['Export', 'Import'] },
    { key: 'product', label: 'Product / Cargo', type: 'text' },
    { key: 'quantity', label: 'Quantity (Kg)', type: 'number' },
    { key: 'unit', label: 'Unit', type: 'text' },
    { key: 'ratePerKg', label: 'Rate per Kg (USD)', type: 'number' },
    { key: 'totalInvoice', label: 'Total Invoice (USD)', type: 'number' },
    ...
    { key: 'cost', label: 'Freight Cost (USD)', type: 'number' },
